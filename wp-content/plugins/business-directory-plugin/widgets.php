 ...
 * @since 2.1
 */
class WPBDP_AllListingsWidget extends WP_Widget {

    public function __construct() {
        parent::__construct(false,
            _x('Business Directory - All Listings', 'widgets', 'WPBDM'),
            array('description' => _x('Displays a complete list of all listings in the Business Directory.', 'widgets', 'WPBDM')));
    }
    ...
    public function form($instance) {
        if (isset($instance['title']))
            ...
            $title = _x('All Listings', 'widgets', 'WPBDM');
    ...
    public function widget($args, $instance) {
        ...
        if ( ! empty( $title ) )
            echo $before_title . $title . $after_title;
        echo wpbdp_all_listings($instance['number_of_listings']);
        echo $after_widget;
    }
